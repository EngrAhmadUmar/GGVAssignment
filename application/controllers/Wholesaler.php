...
class Wholesaler extends CI_Controller
{
    ...
    public function index(){
        if ($this->session->userdata('wholesaler_login') != 0)
    ...
    function rateproduct($param4= ""){ 
        ...
        redirect(base_url().'wholesaler/shop/'.$param4, 'refresh');
        // print_r($data);
    }
        ...
        if($data['status'] == 'failed'){
            if($this->db->update('sales', $data)){
                echo "<script>alert('Your transaction has ".$data['status'].", please try again later');
                    window.location.href='".base_url()."wholesaler/index';</script>";
            }
    ...
    function editproductFunction(){
        ...
        $config1 = array(
            ...
            if($this->upload->do_upload('image1')){
                ...
                $img1 = substr($img, -4);
                if($img1 == ".png"){
                    $data['image1'] = $config['file_name'].".png";}
                elseif($img == ".jpg"){
                    $data['image1'] = $config['file_name'].".jpg";}
                elseif($img == "jpeg"){
                    $data['image1'] = $config['file_name'].".jpeg";}
            }}
        ...
        $config2 = array(
            ...
            if($this->upload->do_upload('image2')){
                ...
                $img2 = substr($img, -4);
                if($img2 == ".png"){
                $data['image2'] = $config['file_name'].".png";}
                elseif($img2 == ".jpg"){
                    $data['image2'] = $config['file_name'].".jpg";}
                elseif($img2 == "jpeg"){
                    $data['image2'] = $config['file_name'].".jpeg";}
            }
        ...
        $config3 = array(
            ...
            if($this->upload->do_upload('image3')){
                $img3 = $_FILES['image']['name'];
                $img3 = substr($img, -4);
                if($img3 == ".png"){
                $data['image3'] = $config['file_name'].".png";}
                elseif($img3 == ".jpg"){
                    $data['image3'] = $config['file_name'].".jpg";}
                elseif($img3 == "jpeg"){
                    $data['image3'] = $config['file_name'].".jpeg";}
            }}
    ...
    function searchresults(){
        $this->load->view('wholesaler/searchresults');
    }
    ...
    function ticketsend(){ 
        ...
        $this->load->view('wholesale/ticket');
        // redirect(base_url().'wholesaler/ticket, 'refresh');
