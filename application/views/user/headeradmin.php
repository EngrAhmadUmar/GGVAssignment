...
<head>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
      ...
      <!--   <link type="text/css" href="<?php echo base_url();?>bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet">
        ...
        <link type="text/css" href='<?php echo base_url();?>http://fonts.googleapis.com/css?family=Open+Sans:400italic,600italic,400,600'
            rel='stylesheet'>
    ...
    <link href="<?php echo base_url();?><?php echo base_url();?>lib/ion-rangeslider/css/ion.rangeSlider.skinFlat.css" rel="stylesheet">
