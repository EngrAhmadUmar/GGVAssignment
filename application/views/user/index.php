                ...
                <li class="glide__slide">
                    <div class="hero__center">
                        <div class="hero__left">
                            ...
                            <a href="<?php echo base_url().'user/shop/'.$product['ID'];?>"><button
                ...
                <div class="collection__box">
                    ...
                    <div class="collection__content">
                        <div class="collection__data">
                            ...
                            <a href="<?php echo base_url().'user/shop/'.$product['ID'];?>">SHOP NOW</a>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
...
?>
        ...
        <div class="form-group">
            <input class="form-control" id="from_places" placeholder="Please enter your Bussiness Address" type="text">
        ...
        <section class="section news" id="news">
            <div class="container">
              ...
              ?>
                      ...
                      echo ".....";?></p>
                                            <a href="<?php echo base_url().'user/news/'.$new['id'];?>"><button
