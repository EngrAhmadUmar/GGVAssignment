...
<?php 
        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          ...
          <?php
$wholesaleuser = $this->db->get_where('wholesaleuser', array('id' =>  $var['wholesaler_id']))->result_array();
foreach($wholesaleuser as $wholesaleusers):
?>
            <p class="mg-b-10">Company Name</p>
              <input class="form-control" placeholder="<?php echo $wholesaleusers['bussinessName'];?>" readonly="" type="text">
              
              <br>
              <p class="mg-b-10">Company Website URL:</p>
              <input class="form-control" placeholder="<?php echo $wholesaleusers['bussinessUrl'];?>" readonly="" type="text">

              
              <br>
              <p class="mg-b-10">Company Description:</p>
              <textarea rows="3" class="form-control" placeholder="<?php echo $wholesaleusers['bussinessDesc'];?>" readonly=""></textarea>
              <br>

              <p class="mg-b-10">Dated Joined Moyata:</p>
              <textarea rows="1" class="form-control" placeholder="<?php echo $wholesaleusers['date'];?>" readonly=""></textarea>
              <br>
          ...
          <input class="form-control" placeholder="<?php echo $wholesaleusers['bussinessaddr1'];?>" readonly="" type="text">
          ...
          <p class="mg-b-10">Phone:</p>
              <div class="input-group">
                ...
                <input readonly="" id="phoneMask" type="text" class="form-control" placeholder="<?php echo $wholesaleusers['phoneNumber'];?>">
              </div><!-- input-group -->
            </div>
          <br>
        <!-- </div> -->
