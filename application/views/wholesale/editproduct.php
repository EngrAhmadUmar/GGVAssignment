...
?>
        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          ...
          <br>
          <form method="POST" action="<?php echo base_url();?>wholesaler/editproductFunction" enctype="multipart/form-data">
          <div class="col-lg mg-t-10 mg-lg-t-0">
            ...
            ?>
              ...
              <textarea rows="3" class="form-control" name="description" placeholder="<?php echo $product['description'];?>"></textarea>
              <br>
              ...
              <input class="form-control" name="availablestock" placeholder="<?php echo $product['availablestock'];?>" type="text">
          ...
          <p class="mg-b-10">Sales Price:</p>
              <input class="form-control" name="salesprice" placeholder="<?php echo $product['salesprice'];?>" type="text">
