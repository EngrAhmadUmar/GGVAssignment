...
?>
          ...
          <br>
          <form method="POST" action="<?php echo base_url();?>wholesaler/editaccount" enctype="multipart/form-data">
          ...
          <div class="col-lg mg-t-10 mg-lg-t-0">
            ...
            <input class="form-control" name="id" value="<?php echo $wholesaleuser['id'];?>" type="hidden">
              ...
              <input class="form-control" name="bussinessName" placeholder="<?php echo $wholesaleuser['bussinessName'];?>" readonly="" type="text">
              
              <br>
              <p class="mg-b-10">Company Website URL:</p>
              <input class="form-control" name="bussinessUrl" placeholder="<?php echo $wholesaleuser['bussinessUrl'];?>" type="text">
          ...
          <input class="form-control" id="from_places" placeholder="<?php echo $wholesaleuser['bussinessaddr1'];?>" type="text">
          ...
          <p class="mg-b-10">Phone:</p>
              <div class="input-group">
                ...
                <input id="phoneMask" type="text" name="phoneNumber" class="form-control" placeholder="<?php echo $wholesaleuser['phoneNumber'];?>">
              </div><!-- input-group -->
            </div>
          <br>
        <!-- </div> -->
        ...
        <hr class="mg-y-30">
          ...
          <input class="form-control" name="facebook" placeholder="<?php echo $wholesaleuser['facebook'];?>" type="text">

          <br>
          <p class="mg-b-10">On Instagram:</p>
          <input class="form-control" name="instagram" placeholder="<?php echo $wholesaleuser['instagram'];?>" type="text">

          <br>
          <p class="mg-b-10">On Twitter:</p>
          <input class="form-control" name="twitter" placeholder="<?php echo $wholesaleuser['twitter'];?>" type="text">
         
         <br>
          <p class="mg-b-10">On Whatsapp:</p>
          <input class="form-control" name="whatsapp" placeholder="<?php echo $wholesaleuser['whatsapp'];?>" type="text">
          <br>
          <br>
          <br>
          </div>
