                ...
                <div class="responsive__cart-area">
                            ...
                            <table width="100%" class="table">
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <form method="POST" action="<?php echo base_url();?>retailer/updatequantity/">
                                            <div class="input-counter">
                                                <div>
                                                    <!-- <span class="minus-btn" id="decrease" onclick="decreaseValue()">
                                                        <img src="https://img.icons8.com/android/24/000000/minus.png"/>
                                                    </span> -->
                                                    <input type="number" id="number" min="1" name="qty" placeholder="<?php echo $data['qty'];?>" class="counter-btn" />
                                        ...
                                        <td class="product__subtotal">
                                            ...
                                            <a href="<?php echo base_url().'retailer/deletecart/'.$data['rowid'];?>" class="remove__cart-item">
                                                <svg>
                        ...
                        <div class="cart-btns">
                            <div class="continue__shopping">
                                <a href="<?php echo base_url().'retailer/retailer_dashboard';?>">Continue Shopping</a>
                            </div>
                        </div>
                        ...
                        <input id="origin" name="origin" name="bussinessaddr1" value="<?php echo $origin; ?>" type="hidden" />
                        <input class="form-control" id="to_places"  placeholder="<?PHP
                                        if(isset($_COOKIE["destination"])){ 
                                        echo $_COOKIE["destination"];
                                    }else{
                                            echo "Please input the location you want your products delivered to.";
                                        }
                                    ?>" type="text">
                        <input id="destination" name="destination" name="addr" type="hidden" />

                        <br>
                        <input class="btn btn-primary" type="submit" value="Calculate Shipping Fee"/></form>
                        ...
                        <div class="cart__totals">
                            ...
                            <ul>
                                ...
                                <li>
                                    Shipping
                                    <span class="new__price" id="shipping">RWF <?PHP 
                                ...
                                <li>
                                    Total
                                    <span class="new__price" id="total">RWF <?PHP
                                        if(isset($_COOKIE["shippingcost"])){
    ...
    $(function() {
        ...
        google.maps.event.addDomListener(window, 'load', function () {
            ...
            google.maps.event.addListener(origin, 'place_changed', function () {
                var from_place = origin.getPlace();
