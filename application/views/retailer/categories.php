<?php
  ...
  foreach($results as $result):
    ...
    $ids = $this->db->get_where('categories', array('id' => $cat))->result_array();
  foreach($ids as $id):
      $cat= $id['categoryname'];
  endforeach;
?>
    ...
    <div class="container">
        <div class="page__title-container">
            <ul class="page__titles">
                <a href="<?php echo base_url().'retailer/index';?>">
                    <svg>
                        <img src="https://img.icons8.com/metro/14/000000/home.png" />
                    </svg>
                </a>
                <li class="page__title"><?php echo $cat ?></li>
            </ul>
        </div>
    </div>
</div>
        ...
        <section class="section related__products">
            <div class="title__container">
                <div class="section__title active" data-id="Latest Products">
                    <span class="dot"></span>
                    <h1 class="primary__title"><?php echo $cat ?></h1>
                </div>
            </div>
                        ...
                        <div class="grid">
                            ...
                            ?>
                                    ...
                                    <li>
                                        ...
                                        <a href="<?php echo base_url().'retailer/shop/'.$result->ID;?>"><button class="btn btn-default btn-xs pull-left" type="button">
