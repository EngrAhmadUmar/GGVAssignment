        ...
        <div class="navigation">
            <div class="container">
              ...
              <use xlink:href="images/sprite.svg#icon-menu"></use>
                    ...
                    <div class="nav__logo">
                        <a href="<?php echo base_url().'retailer/index/';?>" class="scroll-link">
                    ...
                    <div class="nav__menu">
                        <div class="menu__top">
                            ...
                            <a href="<?php echo base_url().'retailer/index';?>" class="close__toggle">
                    ...
                    <div class="nav__icons">
                        ...
                        <a href="<?php echo base_url().'retailer/profile/';?>" class="icon__item">
                            <img src="https://img.icons8.com/metro/26/000000/user-male.png" />
                        </a>

                        <a href="<?php echo base_url().'retailer/cart/';?>" class="icon__item">
            ...
            <div class="modal-content">
                ...
                <div class="overlay-content">
                    <div class="container-fluid">
                        <form class="d-flex" method="POST" action="<?php echo base_url();?>retailer/searchbar">
